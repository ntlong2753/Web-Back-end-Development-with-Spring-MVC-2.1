...
@Component
public class Logger {
    @AfterThrowing(pointcut = "execution(public * com.codegym.customermanageaspect.service.ICustomerService.findAll(..))", throwing = "e")
    public void logMethod(Exception e) {
        System.out.println("[CMS] co loi xay ra: " + e.getMessage());
    }

    @AfterThrowing(pointcut = "execution(public * com.codegym.customermanageaspect.service.ICustomerService.*(..))", throwing = "e")
